...
<p>2) The other option is for you to write your code and then upload it to our server via the FTP login and check your work in the browser (<b>http://interview-yt.idevdesign.net/</b>). Before you hand in your test, you'll need to make sure it works on our server like this as we can't check the results on your computer - we can only check them on our server.

<p><b>How can I check my work?</b>
<br>You should check your work by going to the <b>http://interview-yt.idevdesign.net/</b> site and making sure that the pages are working correctly. That is how we are going to be testing your work - by first going to the interview URL and pulling up the pages, then looking at your code after that.
